...
.. literalinclude:: ../examples/python/ping_pong.py
    :caption: examples/python/ping_pong.py
    :linenos:

Alarm
-----

.. literalInclude:: ../examples/python/alarm.py
    :caption: examples/python/alarm.py
    :linenos:
